...
import { ResponseCommunityProps } from "../type/response";
  ...
  return (
    <div className="flex flex-col gap-2 pt-2">
      ...
      <div className="flex flex-row justify-start gap-5 items-center">
        ...
        <p className="text-[13px] font-medium">View {comments} comments</p>
      </div>
    </div>
  );
};

export default ResponseCommunity;
